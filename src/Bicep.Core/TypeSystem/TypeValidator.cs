    ...
    public class TypeValidator
    {
        ...
        private TypeSymbol NarrowDiscriminatedObjectType(TypeValidatorConfig config, ObjectSyntax expression, DiscriminatedObjectType targetType)
        {
            ...
            if (discriminatorProperty == null)
            {
                ...
                {
                    diagnosticWriter.Write(config.OriginSyntax ?? expression, x => x.DisallowedPropertyWithSuggestion(ShouldWarn(targetType), misspelledDiscriminatorKey, targetType.DiscriminatorKeysUnionType, targetType.DiscriminatorKey));
                }
